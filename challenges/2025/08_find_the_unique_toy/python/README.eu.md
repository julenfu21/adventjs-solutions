<div align="center">
    <h1>Erronka #8: 🎁 Jostailu Bakana Aurkitu — Python</h1>
</div>
...
Karpeta honek Erronka #8ko **ebazpena eta testak** ditu, <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python**-ekin osatutakoak. Erronkaren azalpen zehaztuagoa ikusteko jo [Erronka #8ren README nagusira](../README.eu.md).
...
```bash
# <test_funtzioa> = {test_find_unique_toy_returns_string, test_find_unique_toy}
...
pytest test_solution.py::test_find_unique_toy[test-<indizea>]
```
...
- Kodeak era egokian aurkitzen du errepikatzen ez den lehenengo hizkia, hizki larri eta xeheak bereizi gabe.
- Errepikatzen ez den hizkirik ez dagoen salbuespen-kasua ondo kudeatzen da.
- `defaultdict`-aren erabilera eraginkorra da karaktereen maiztasuna kontatzeko.
