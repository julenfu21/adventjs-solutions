<div align="center">
    <h1>Reto #15: ✏️ Dibujando Tablas — Python</h1>
</div>
...
Esta carpeta contiene los **tests y soluciones** del Reto #15 en <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python**. Para instrucciones más detalladas ir al [README principal del Reto #15](../README.es.md).
...
```bash
# <función_de_test> = {test_draw_table_returns_string, test_draw_table}
...
pytest test_solution.py::test_draw_table[test-<índice>]
```
