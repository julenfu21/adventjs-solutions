<div align="center">
    <h1>Challenge #15: ✏️ Drawing Tables — Python</h1>
</div>
...
This folder contains the <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python solution and tests** for Challenge #15. Refer to the [main README of Challenge #15](../README.md) for more detailed instructions.
...
```bash
# <test_function> = {test_draw_table_returns_string, test_draw_table}
...
pytest test_solution.py::test_draw_table[test-<index>]
```
