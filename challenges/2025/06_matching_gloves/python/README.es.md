<div align="center">
    <h1>Reto #6: 🧤 Emparejando Guantes — Python</h1>
</div>
...
Esta carpeta contiene los **tests y soluciones** del Reto #6 en <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python**. Para instrucciones más detalladas ir al [README principal del Reto #6](../README.es.md).
...
```bash
# <función_de_test> = {test_match_gloves_returns_list, test_match_gloves}
...
pytest test_solution.py::test_match_gloves[test-<índice>]
```
