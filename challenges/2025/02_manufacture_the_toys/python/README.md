<div align="center">
    <h1>Challenge #2: 🏭 Manufacture the Toys — Python</h1>
</div>
...
This folder contains the <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python solution and tests** for Challenge #2. Refer to the [main README of Challenge #2](../README.md) for more detailed instructions.
