<div align="center">
    <h1>Erronka #16: 🎁 Opariak Bizarzurirentzat Paketatzen — Python</h1>
</div>
...
Karpeta honek Erronka #16ko **ebazpena eta testak** ditu, <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python**-ekin osatutakoak. Erronkaren azalpen zehaztuagoa ikusteko jo [Erronka #16ren README nagusira](../README.eu.md).
...
```bash
# <test_funtzioa> = {test_pack_gifts_returns_int, test_pack_gifts}
...
pytest test_solution.py::test_pack_gifts[test-<indizea>]
```
...
- Kodeak sarrera-parametro gisa zerrenda hutsa jasotzen den salbuespen-kasua ondo kudeatzen du.
- Erabili beharreko lera kopurua zehazteko logika argia eta eraginkorra da.
- Funtzioak `null` balioa era egokian itzutzen du, opari batek leraren pisu maximoa gainditzen duenean.
