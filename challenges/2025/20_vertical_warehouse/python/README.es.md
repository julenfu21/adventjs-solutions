<div align="center">
    <h1>Reto #20: 🎁 El Almacén Vertical — Python</h1>
</div>
...
Esta carpeta contiene los **tests y soluciones** del Reto #20 en <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python**. Para instrucciones más detalladas ir al [README principal del Reto #20](../README.es.md).
...
```bash
# <función_de_test> = {test_drop_gifts_returns_list, test_drop_gifts}
...
pytest test_solution.py::test_drop_gifts[test-<índice>]
```
