<div align="center">
    <h1>Reto #21: 🤖 El Robot de Limpieza — Python</h1>
</div>
...
Esta carpeta contiene los **tests y soluciones** del Reto #21 en <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python**. Para instrucciones más detalladas ir al [README principal del Reto #21](../README.es.md).
...
```bash
# <función_de_test> = {test_clear_gifts_returns_list, test_clear_gifts}
...
pytest test_solution.py::test_clear_gifts[test-<índice>]
```
