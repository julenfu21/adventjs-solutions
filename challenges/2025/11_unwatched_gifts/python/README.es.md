<div align="center">
    <h1>Reto #11: 📹 Regalos sin Vigilancia — Python</h1>
</div>
...
Esta carpeta contiene los **tests y soluciones** del Reto #11 en <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python**. Para instrucciones más detalladas ir al [README principal del Reto #11](../README.es.md).
...
```bash
# <función_de_test> = {test_find_unsafe_gifts_returns_int, test_find_unsafe_gifts}
...
pytest test_solution.py::test_find_unsafe_gifts[test-<índice>]
```
