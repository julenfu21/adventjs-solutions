<div align="center">
    <h1>Challenge #11: 📹 Unwatched Gifts — Python</h1>
</div>
...
This folder contains the <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python solution and tests** for Challenge #11. Refer to the [main README of Challenge #11](../README.md) for more detailed instructions.
...
```bash
# <test_function> = {test_find_unsafe_gifts_returns_int, test_find_unsafe_gifts}
...
pytest test_solution.py::test_find_unsafe_gifts[test-<index>]
```
