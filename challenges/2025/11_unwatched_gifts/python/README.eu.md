<div align="center">
    <h1>Erronka #11: 📹 Zaintzarik Gabeko Opariak — Python</h1>
</div>
...
Karpeta honek Erronka #11ko **ebazpena eta testak** ditu, <img src="../../../../assets/python-logo.png" alt="Python" width="20" style="vertical-align: middle;"> **Python**-ekin osatutakoak. Erronkaren azalpen zehaztuagoa ikusteko jo [Erronka #11ren README nagusira](../README.eu.md).
...
```bash
# <test_funtzioa> = {test_find_unsafe_gifts_returns_int, test_find_unsafe_gifts}
...
pytest test_solution.py::test_find_unsafe_gifts[test-<indizea>]
```
...
- Kodeak era egokian antzematen eta kontatzen ditu zaintzarik gabeko opariak, biltegi osotik zehar iteratzen eta ondoko posizioetan ea kamerarik dagoen aztertuz.
- Ondoko posizio bat aztertu baino lehen mugen egiaztapenerako erabiltzen den logika sendoa da.
